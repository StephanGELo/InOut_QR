            ...
            <div className="flex items-center space-x-4">
              <a href="/" className="hover:scale-105 transition-transform duration-300">
                <img 
                  src="/assets/logo.png" 
                  alt="InOut QR logo" 
                  className="h-12 w-12 rounded-full border-2 border-yellow-500/60 shadow-lg" 
                />
              </a>
              <div>
                <div className="flex items-center space-x-2">
                  ...
                  <div className="inline-flex items-center px-3 py-1 bg-gradient-to-r from-yellow-600/20 to-amber-600/20 border border-yellow-600/30 rounded-full">
                ...
                <p className="text-stone-400 text-sm">Administrator Dashboard</p>
              </div>
            </div>
            
            <button
              className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-yellow-700/30 to-amber-700/30 hover:from-yellow-600/40 hover:to-amber-600/40 border border-yellow-600/40 hover:border-yellow-500/60 text-yellow-300 hover:text-yellow-200 rounded-lg transition-all duration-200 hover:scale-105"
              onClick={() => {
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section className="mb-8">
          <div className="bg-stone-800/50 backdrop-blur-sm border border-stone-700/50 rounded-2xl p-6 sm:p-8 hover:border-yellow-400/30 transition-colors duration-300">
            ...
            <div className="bg-stone-900/50 rounded-xl p-6 border border-stone-600/30">
                ...
                <table className="min-w-full">
                  <thead>
                    <tr className="border-b border-stone-600/50">
                      <th className="px-4 py-3 text-left text-xs font-medium text-yellow-400 uppercase tracking-wider">Emp ID</th>
                      <th className="px-4 py-3 text-left text-xs font-medium text-yellow-400 uppercase tracking-wider">Name</th>
                      <th className="px-4 py-3 text-left text-xs font-medium text-yellow-400 uppercase tracking-wider">Email</th>
                      <th className="px-4 py-3 text-left text-xs font-medium text-yellow-400 uppercase tracking-wider">Date</th>
                      <th className="px-4 py-3 text-left text-xs font-medium text-yellow-400 uppercase tracking-wider">Check-in</th>
                      <th className="px-4 py-3 text-left text-xs font-medium text-yellow-400 uppercase tracking-wider">Check-out</th>
                    ...
                    {attendanceLogs.length ? (
                      attendanceLogs.map((log, index) => (
                        <tr key={index} className="hover:bg-stone-800/30 transition-colors duration-150">
                          <td className="px-4 py-3 text-sm text-stone-300 font-medium">{log.id}</td>
                          <td className="px-4 py-3 text-sm text-stone-300">{log.name}</td>
                          <td className="px-4 py-3 text-sm text-stone-400">{log.email}</td>
                          <td className="px-4 py-3 text-sm text-stone-300">{new Date(log.date).toLocaleDateString()}</td>
                          <td className="px-4 py-3 text-sm text-stone-300">{log.check_in || '-'}</td>
                          <td className="px-4 py-3 text-sm text-stone-300">{log.check_out || '-'}</td>
        ...
        <section className="mb-8">
          <div className="bg-stone-800/50 backdrop-blur-sm border border-stone-700/50 rounded-2xl p-6 sm:p-8 hover:border-yellow-400/30 transition-colors duration-300">
            ...
            <div className="bg-stone-900/30 rounded-xl p-4 border border-stone-600/30">
              <EmployeeList />
            </div>
          </div>
        </section>
        ...
        <section className="mb-8">
          <div className="bg-stone-800/50 backdrop-blur-sm border border-stone-700/50 rounded-2xl p-6 sm:p-8 hover:border-yellow-400/30 transition-colors duration-300">
            ...
            <div className="bg-stone-900/30 rounded-xl p-6 border border-stone-600/30">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-stone-300 mb-2">Current QR Code:</p>
                  <div className="inline-flex items-center px-4 py-2 bg-yellow-900/20 border border-yellow-600/30 rounded-lg">
                    <svg className="w-5 h-5 text-yellow-400 mr-2" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M3 4a1 1 0 011-1h3a1 1 0 011 1v3a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 13a1 1 0 011-1h3a1 1 0 011 1v3a1 1 0 01-1 1H4a1 1 0 01-1-1v-3zM12 4a1 1 0 011-1h3a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1V4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-yellow-300 font-mono text-sm">INOUTQR_CHECKIN_CODE_2024Q4</span>
                  </div>
                </div>
                
                <button className="flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-yellow-600 to-amber-600 hover:from-yellow-500 hover:to-amber-500 text-white font-medium rounded-lg transition-all duration-200 hover:scale-105 hover:shadow-lg hover:shadow-yellow-500/20">
